...
-   [**DKPLM: Decomposable Knowledge-Enhanced Pre-trained Language Model**](https://ojs.aaai.org/index.php/AAAI/article/view/21426)  
...
-   [**KnowLog: Knowledge Enhanced Pre-trained Language Model for Log Understanding**](https://dl.acm.org/doi/10.1145/3597503.3623315)  
...
-   [**BAYESPROMPT: Prompting Large-Scale Pre-Trained Language Models on Few-Shot Inference via Debiased Domain Abstraction**](https://arxiv.org/abs/2401.14166)  
    Li J, Song F, Jin Y, et al. ArXiv, 2024
-   [**KG-prompt: Interpretable Knowledge Graph Prompt for Pre-trained Language Models**](https://doi.org/10.1016/j.knosys.2024.111968)  
...
-   [**RD-P: A Trustworthy Retrieval-Augmented Prompter with Knowledge Graphs for LLMs**](https://doi.org/10.1145/3627673.3679611)  
    Huang Y, Zeng G. CIKM, 2024
-   [**KG-CoT: Chain-of-Thought Prompting of Large Language Models over Knowledge Graphs**](https://arxiv.org/abs/2403.07823)  
...
-   [**KG-Rank: Enhancing Large Language Models for Medical QA with Knowledge Graphs and Ranking Techniques**](https://aclanthology.org/2024.bionlp-1.14/)  
...
-   [**PoG: Paths-over-Graph: Knowledge Graph Enpowered Large Language Model Reasoning**](https://doi.org/10.1145/3690134.3710298)  
    Tan X, Wang X, Liu Q, et al. WWW, 2025
-   [**R³: Right for Right Reasons: Large Language Models for Verifiable Commonsense Knowledge Graph Question Answering**](https://aclanthology.org/2024.emnlp-main.392/)  
    Toroghi A, Guo W, Pour M M A, et al. EMNLP, 2024
-   [**PoG: Plan-on-Graph: Self-Correcting Adaptive Planning of Large Language Model on Knowledge Graphs**](https://openreview.net/forum?id=...)  
    Chen L, Tong P, Jin Z, et al. NeurIPS, 2024
-   [**GoG: Generate-on-Graph: Treat LLM as both Agent and KG for Incomplete KGQA**](https://arxiv.org/abs/2404.10024)  
    Xu Y, He S, Chen J, et al. EMNLP, 2024
-   [**Triad: A Framework Leveraging a Multi-Role LLM-based Agent to Solve Knowledge Base Question Answering**](https://aclanthology.org/2024.emnlp-main.104/)  
...
-   [**Rule-KBQA: Rule-Guided Reasoning for Complex Knowledge Base Question Answering**](https://aclanthology.org/2025.coling-main.558/)  
    Zhang Z, Wen L, Zhao W. COLING, 2025

**Post-execution Enhancement**

-   [**KB-BINDER: Few-Shot Semantic Parsing**](https://arxiv.org/abs/2305.08772)  
...
-   [**Knowledge-CLIP: Knowledge-Based Pre-training Objectives using Diverse Knowledge Graphs**](https://arxiv.org/abs/2209.10398)  
    Pan X, Ye T, Han D, et al. NeurIPS, 2022
-   [**REAVL: Retrieval-Based Knowledge Augmented Vision Language Pre-Training**](https://dl.acm.org/doi/10.1145/3581783.3611913)  
...
-   [**UKnow: A Unified Knowledge Protocol with Multimodal Knowledge Graph Datasets**](https://arxiv.org/abs/2402.05391)  
    Gong B, Tan S, Feng Y, et al. NeurIPS, 2024
-   [**KTIR: Knowledge-Aware Text-Image Retrieval for Remote Sensing Images**](https://ieeexplore.ieee.org/document/10477488)  
    Mi L, Dai X, Castillo-Navarro J, et al. IEEE TGRS, 2024
-   [**KMRec: Knowledge-Aware User Multi-Interest Modeling Method for News Recommendation**](https://link.springer.com/article/10.1007/s10115-025-02319-1)  
...
-   [**KAM-CoT: Knowledge Augmented Multimodal Chain-of-Thoughts Reasoning**](https://ojs.aaai.org/index.php/AAAI/article/view/30089)  
    Mondal D, Modi S, Panda S, et al. AAAI, 2024
-   [**KECPM: Few-Shot Joint Multimodal Entity-Relation Extraction via Knowledge-Enhanced Cross-Modal Prompt Model**](https://dl.acm.org/doi/10.1145/3664647.3681423)  
    Yuan L, Cai Y, Huang J. ACM MM, 2024

**In-execution Enhancement**

-   [**IKIR: Inferential Knowledge-Enhanced Integrated Reasoning for Video Question Answering**](https://ojs.aaai.org/index.php/AAAI/article/view/26569)  
    Mao J, Jiang W, Liu H. AAAI, 2023
-   [**KVQAE: Explicit Knowledge Integration for Knowledge-Aware Visual Question Answering about Named Entities**](https://dl.acm.org/doi/10.1145/3591106.3592237)  
    Adjali O, Grimal P, Ferret O, et al. ICMR, 2023
-   [**MMV: Multi-Modal Validation and Domain Interaction Learning for Knowledge-Based Visual Question Answering**](https://ieeexplore.ieee.org/document/10530366)  
    Xu N, Gao Y, Liu A A, et al. IEEE TKDE, 2024
-   [**KAMV: Knowledge Augmented Multimodal-based Framework for Video Summarization**](https://doi.org/10.1145/3503161.3547849)  
...
-   [**Knowledge Enhanced Vision and Language Model for Multi-modal Fake News Detection**](https://ieeexplore.ieee.org/document/10497825)  
...
-   [**K-Link: Knowledge-Link Graph from LLMs for Enhanced Representation Learning**](https://arxiv.org/abs/2403.03645)  
...
-   [**TableTime: Reformulating Time Series Classification as Zero-Shot Table Understanding**](https://arxiv.org/abs/2411.15737)  
    Wang J, Cheng M, Mao Q, et al. ArXiv, 2024
...
-   [**RATD: Retrieval-Augmented Diffusion Models for Time Series Forecasting**](https://proceedings.neurips.cc/paper_files/paper/2024/hash/0333d455c1e57c664b4231862590212f-Abstract-Conference.html)  
    Liu J, Yang L, Li H, et al. NeurIPS, 2024
-   [**DGTFAD: Incorporating Prior Knowledge for Domain Generalization Traffic Flow Anomaly Detection**](https://link.springer.com/article/10.1007/s00521-024-10659-3)  
    Chen B, Fang M, Wei H J. Neural Comput Applic, 2025

**In-execution Enhancement**

-   [**PKET-GCN: Prior Knowledge Enhanced Time-Varying Graph Convolution Network**](https://doi.org/10.1016/j.ins.2023.03.090)  
...
-   [**MAGNN: Financial Time Series Forecasting with Multi-Modality Graph Neural Network**](https://doi.org/10.1016/j.patcog.2021.108218)  
...
-   [**STDDE: Unveiling Delay Effects in Traffic Forecasting**](https://dl.acm.org/doi/10.1145/3589334.3645607)  
...
-   [**ChatTime: A Unified Multimodal Time Series Foundation Model**](https://arxiv.org/abs/2412.11376)  
    Wang C, Qi Q, Wang J, et al. ArXiv, 2024
-   [**CAP: Causal and Interpretable Rules for Time Series Analysis**](https://dl.acm.org/doi/10.1145/3447548.3467160)  
...
-   [**PI-DKL: Physics Informed Deep Kernel Learning**](https://proceedings.mlr.press/v151/wang22b.html)  
    Wang Z, Xing W, Kirby R, et al. AISTATS, 2022
-   [**Learning to Dehaze with Polarization**](https://proceedings.neurips.cc/paper/2021/hash/6005d766542f704179e735520e74f210-Abstract.html)  
    Zhou C, Teng M, Han Y, et al. NeurIPS, 2021
-   [**Using a Physics-Informed Neural Network and Fault Zone Acoustic Monitoring to Predict Lab Earthquakes**](https://www.nature.com/articles/s41467-023-39396-8)  
...
-   [**MV-Mol: Learning Multi-View Molecular Representations with Structured and Unstructured Knowledge**](https://dl.acm.org/doi/10.1145/3637528.3671887)  
    Luo Y, Yang K, Hong M, et al. KDD, 2024
-   [**Reaction Performance Prediction with an Extrapolative and Interpretable Graph Model**](https://www.nature.com/articles/s41467-023-39304-0)  
    Li S W, Xu L C, Zhang C, et al. Nat Commun, 2023

**Biology**

-   [**GEARS: Predicting Transcriptional Outcomes of Novel Multigene Perturbations**](https://www.nature.com/articles/s41587-023-01968-3)  
    Roohani Y, Huang K, Leskovec J. Nat Biotechnol, 2024
-   [**KG-MTL: Knowledge Graph Enhanced Multi-Task Learning for Molecular Interaction**](https://ieeexplore.ieee.org/document/9903332)  
...
-   [**KeAP: Protein Representation Learning via Knowledge Enhanced Primary Structure Modeling**](https://arxiv.org/abs/2301.13154)  
    Zhou H Y, Fu Y, Zhang Z, et al. ArXiv, 2023
...
-   [**KAD: Knowledge-enhanced Auto Diagnosis**](https://www.nature.com/articles/s41467-023-43339-w)  
    Zhang X, Wu C, Zhang Y, et al. Nat Commun, 2023
-   [**Align, Reason and Learn: Enhancing Medical Vision-and-Language Pre-training with Knowledge**](https://dl.acm.org/doi/10.1145/3503161.3548324)  
...
-   [**MedRec: Knowledge-Enhanced Attributed Multi-Task Learning for Medicine Recommendation**](https://dl.acm.org/doi/10.1145/3569931)  
...
-   [**HRGR-Agent: Hybrid Retrieval-Generation Reinforced Agent for Medical Image Report Generation**](https://proceedings.neurips.cc/paper/2018/hash/4e2544270d47e45295c4749f76a7756f-Abstract.html)  
...
-   [**Rolling Bearing Fault Diagnosis Method Based on Multimodal Knowledge Graph**](https://ieeexplore.ieee.org/document/10497645)  
    Peng C, Sheng Y, Gui W, et al. IEEE TII, 2024

**Resource Allocation**

-   [**Novel Knowledge Graph-Based Optimization Approach for Resource Allocation**](https://doi.org/10.1016/j.rcim.2021.102160)  
    Zhou B, Bao J, Li J, et al. Robot Comput-Integrated Manuf, 2021
-   [**Knowledge Graph-Enhanced Multi-Agent Reinforcement Learning for Adaptive Scheduling**](https://link.springer.com/article/10.1007/s10845-024-02341-w)  
...
-   [**Process Design Intent Inference Method of Process Data via Integrating Deep Learning and Grammar Parsing**](https://doi.org/10.1016/j.aei.2023.102174)  
    Huang R, Han Z, Fei M, et al. Adv Eng Inf, 2023
-   [**Knowledge Graph with Deep Reinforcement Learning for Intelligent Generation of Machining Process Design**](https://www.tandfonline.com/doi/full/10.1080/09544828.2024.2330661)  
